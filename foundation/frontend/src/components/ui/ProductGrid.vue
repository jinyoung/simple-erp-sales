<template>
    <div style="max-height:80vh;">
        ...
        <wj-flex-grid
            ...
            class="wj-felx-grid"
        >
            <wj-flex-grid-filter :filterColumns="['RowHeader','productType','manufacturer','status',]" />
            <wj-flex-grid-cell-template cellType="RowHeader" v-slot="cell">{{cell.row.index + 1}}</wj-flex-grid-cell-template>
            <wj-flex-grid-column binding="productType" header="제품 유형" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="manufacturer" header="제조사" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="status" header="상태" width="2*" :isReadOnly="true" align="center" />
        </wj-flex-grid>
        <v-col>
            <v-dialog
                v-model="openDialog"
                ...
                <template>
                    <v-card>
                        <v-toolbar
                            ...
                            height="50px"
                        >
                            <div style="color:white; font-size:17px; font-weight:700;">제품 등록</div>
                            <v-spacer></v-spacer>
                            <v-icon
                                color="white"
                                small
